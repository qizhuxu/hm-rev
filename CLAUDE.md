...
This project is indexed by GitNexus as **hm-rev** (374 symbols, 1100 relationships, 32 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
